      ...
      <div class="navbar navbar-inverse navbar-static-top " role="navigation">
        ...
        <div class="row">
          <div class="col-lg-4" align="center">
            <img class="img-circle" src="https://i0.wp.com/www.palatesdesire.com/wp-content/uploads/2019/09/Mysore_Masala_Dosa@Palates_Desire-e1593275925544.jpg?fit=3000%2C2162&ssl=1" width="500" height="300">
            <br><h2>MASALA DOSA
      ...
      <div class="carousel-inner">
        <div class="item active">
          <div class="row">
            ...
            <div class="col-lg-4" align="center">
              <img src="https://www.awesomecuisine.com/wp-content/uploads/2009/06/Plain-Dosa.jpg" alt="Generic placeholder image" width="500" height="350">
              <h4>DOSA</h4>
                          </div><!-- /.col-lg-4 -->
          </div><!-- /.row -->
        </div>
